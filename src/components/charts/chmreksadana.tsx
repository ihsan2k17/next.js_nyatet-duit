...
const ChartMobileReksadana = ({data, loading, portfolios, alert, sumNamePerPortfolio, countProduct}: Ccmreksadanaprops) => {
        ...
        <div className={`flex w-full gap-5 p-1.5 pb-3 bg-white rounded-3xl shadow-[0_6px_24px_rgba(0,0,0,0.05)] border border-slate-100`}>
            {loading ? (
                ...
                <div className="relative w-full flex flex-col gap-2 ">
                    ...
                    {/* Total per portfolio */}
                    <MSumPortfolio sumNamePerPortfolio={sumNamePerPortfolio} countProduct={countProduct}/>
                </div>
            )}
        </div>
    )
