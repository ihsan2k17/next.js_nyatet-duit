...
const CardMobileBalance = ({sumPerPortfolio,loading, card, alert }:CarMdBalanceProps) => {
  ...
  return (
    <div className={`relative flex flex-1 min-w-[320px] w-full bg-gradient-to-r from-secondary via-button-secondary to-button-primary 
      rounded-2xl 
      shadow-xl 
      p-4 
      flex-col 
      ...
      {/* Balance */}
      <div className="mb-5">
        <p className="text-xs font-semibold opacity-80">Total Balance</p>
...
export default CardMobileBalance
