...
const Success = ({ show, onClose, onConfirm, Message, pbutton, title }: SuccessProps) => {
    return (
        <AnimatePresence>
            {show && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className="mt-8 flex justify-center">
                            <button
                                onClick={onConfirm}
                                className="px-6 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-700 
